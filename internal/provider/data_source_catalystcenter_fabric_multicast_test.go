...
func TestAccDataSourceCcFabricMulticast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_fabric_multicast.test", "ipv4_ssm_ranges.0", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_fabric_multicast.test", "multicast_r_ps.0.rp_device_location", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_fabric_multicast.test", "multicast_r_ps.0.network_device_ids.0", ""))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcFabricMulticastConfig(),

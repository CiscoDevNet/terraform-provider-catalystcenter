...
func TestAccDataSourceCcFabricMulticastVirtualNetworks(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcFabricMulticastVirtualNetworksPrerequisitesConfig + testAccDataSourceCcFabricMulticastVirtualNetworksConfig(),
...
const testAccDataSourceCcFabricMulticastVirtualNetworksPrerequisitesConfig = `
...
func testAccDataSourceCcFabricMulticastVirtualNetworksConfig() string {
	config := `resource "catalystcenter_fabric_multicast_virtual_networks" "test" {` + "\n"
	...
	config += `
		data "catalystcenter_fabric_multicast_virtual_networks" "test" {
			id = catalystcenter_fabric_multicast_virtual_networks.test.id

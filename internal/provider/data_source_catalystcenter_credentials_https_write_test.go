...
func TestAccDataSourceCcCredentialsHTTPSWrite(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcCredentialsHTTPSWriteConfig(),
...
func testAccDataSourceCcCredentialsHTTPSWriteConfig() string {
	...
	config += `
		data "catalystcenter_credentials_https_write" "test" {
			id = catalystcenter_credentials_https_write.test.id
		}
	`
	return config
}

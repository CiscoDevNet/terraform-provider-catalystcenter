...
func TestAccCcNTPSettings(t *testing.T) {
...
const testAccCcNTPSettingsPrerequisitesConfig = `
...
func testAccCcNTPSettingsConfig_minimum() string {
...
func testAccCcNTPSettingsConfig_all() string {
	config := `resource "catalystcenter_ntp_settings" "test" {` + "\n"
	config += `	site_id = catalystcenter_area.test.id` + "\n"

...
var (
	_ datasource.DataSource              = &AreaDataSource{}
	_ datasource.DataSourceWithConfigure = &AreaDataSource{}
)
...
func (d *AreaDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Area.",

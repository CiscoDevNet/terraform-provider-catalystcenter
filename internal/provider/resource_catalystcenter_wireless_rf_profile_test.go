...
func TestAccCcWirelessRFProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "radio_type_a_radio_channels", "36,40,44,48,124,128,157,161"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "radio_type_a_mandatory_data_rates", "6"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "radio_type_b_parent_profile", "HIGH"))

...
func TestAccCcWirelessRFProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "name", "RF_Profile_1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "enable_radio_type_c", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "channel_width", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "enable_custom", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_wireless_rf_profile.test", "enable_brown_field", "false"))
	...
	steps = append(steps, resource.TestStep{
		ResourceName: "catalystcenter_wireless_rf_profile.test",
		ImportState:  true,
	})

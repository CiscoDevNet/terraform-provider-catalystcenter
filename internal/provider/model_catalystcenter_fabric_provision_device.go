...
func (data FabricProvisionDevice) getPath() string {
...
func (data FabricProvisionDevice) toBody(ctx context.Context, state FabricProvisionDevice) string {
	body := ""
	put := false
...
func (data *FabricProvisionDevice) fromBody(ctx context.Context, res gjson.Result) {

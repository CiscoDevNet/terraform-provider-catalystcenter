...
func TestAccCcIPPool(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_ip_pool.test", "dhcp_server_ips.0", "1.2.3.4"))
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_ip_pool.test", "dns_server_ips.0", "2.3.4.5"))

...
func TestAccCcArea(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("catalystcenter_area.test", "name", "Area1"))
	...
	steps = append(steps, resource.TestStep{
		ResourceName: "catalystcenter_area.test",
		ImportState:  true,
	})

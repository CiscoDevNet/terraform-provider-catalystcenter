...
func (d *DNSSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the DNS Settings.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"domain_name": schema.StringAttribute{
				MarkdownDescription: "Network's domain name",
				Computed:            true,
			},
			"dns_servers": schema.SetAttribute{
				MarkdownDescription: "DNS servers for hostname resolution",
...
func (d *DNSSettingsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {

...
func TestAccDataSourceCcDeviceReplacement(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcDeviceReplacementConfig(),
...
func testAccDataSourceCcDeviceReplacementConfig() string {
	...
	config += `
		data "catalystcenter_device_replacement" "test" {
			id = catalystcenter_device_replacement.test.id
		}
	`
	return config
}

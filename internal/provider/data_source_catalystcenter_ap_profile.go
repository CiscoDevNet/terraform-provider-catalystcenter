				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"calendar_profile_name": schema.StringAttribute{
							MarkdownDescription: "Name of the calendar profile. This is auto-generated by the API and read-only.",
							Computed:            true,
						},
						...
						"scheduler_day": schema.SetAttribute{
							MarkdownDescription: "Days for WEEKLY scheduler as a set of lowercase day names (e.g., ['saturday', 'sunday']). Required when schedulerType is WEEKLY.",
							ElementType:         types.StringType,
							Computed:            true,
						},
						"scheduler_date": schema.SetAttribute{
							MarkdownDescription: "Dates for MONTHLY scheduler as a set of date strings (e.g., ['1', '15']). Required when schedulerType is MONTHLY.",
							ElementType:         types.StringType,
							Computed:            true,
						},
					},

...
func TestAccCcAssignTemplatesToTag(t *testing.T) {
	var checks []resource.TestCheckFunc

	var steps []resource.TestStep
	steps = append(steps, resource.TestStep{
		Config: testAccCcAssignTemplatesToTagPrerequisitesConfig + testAccCcAssignTemplatesToTagConfig_all(),
...
const testAccCcAssignTemplatesToTagPrerequisitesConfig = `
...
func testAccCcAssignTemplatesToTagConfig_minimum() string {

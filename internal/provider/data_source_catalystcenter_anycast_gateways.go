...
var (
	_ datasource.DataSource              = &AnycastGatewaysDataSource{}
	_ datasource.DataSourceWithConfigure = &AnycastGatewaysDataSource{}
)

func NewAnycastGatewaysDataSource() datasource.DataSource {
	return &AnycastGatewaysDataSource{}
}

type AnycastGatewaysDataSource struct {
	client *cc.Client
}

func (d *AnycastGatewaysDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_anycast_gateways"
}

func (d *AnycastGatewaysDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Anycast Gateways.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"anycast_gateways": schema.SetNestedAttribute{
				MarkdownDescription: "List of anycast gateways",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "ID of the anycast gateway",
							Computed:            true,
						},
						"fabric_id": schema.StringAttribute{
							MarkdownDescription: "ID of the fabric to contain this anycast gateway",
						...
						"group_based_policy_enforcement_enabled": schema.BoolAttribute{
							MarkdownDescription: "Enable/disable Group-Based Policy Enforcement (applicable only to INFRA_VN; defaults to false)",
							Computed:            true,
						},
...
func (d *AnycastGatewaysDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *AnycastGatewaysDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config AnycastGateways

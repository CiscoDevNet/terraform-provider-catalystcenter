...
var (
	_ datasource.DataSource              = &FabricMulticastVirtualNetworkDataSource{}
	_ datasource.DataSourceWithConfigure = &FabricMulticastVirtualNetworkDataSource{}
)

func NewFabricMulticastVirtualNetworkDataSource() datasource.DataSource {
	return &FabricMulticastVirtualNetworkDataSource{}
}

type FabricMulticastVirtualNetworkDataSource struct {
	client *cc.Client
}

func (d *FabricMulticastVirtualNetworkDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_fabric_multicast_virtual_network"
}

func (d *FabricMulticastVirtualNetworkDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Fabric Multicast Virtual Network.",
...
func (d *FabricMulticastVirtualNetworkDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *FabricMulticastVirtualNetworkDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config FabricMulticastVirtualNetwork

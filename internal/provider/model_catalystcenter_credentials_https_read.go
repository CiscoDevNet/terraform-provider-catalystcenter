...
func (data CredentialsHTTPSRead) getPath() string {
...
func (data *CredentialsHTTPSRead) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *CredentialsHTTPSRead) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data *CredentialsHTTPSRead) isNull(ctx context.Context, res gjson.Result) bool {
	if !data.Description.IsNull() {
		return false
	}
	if !data.Username.IsNull() {

...
var (
	_ datasource.DataSource              = &FabricL3HandoffIPTransitsDataSource{}
	_ datasource.DataSourceWithConfigure = &FabricL3HandoffIPTransitsDataSource{}
)

func NewFabricL3HandoffIPTransitsDataSource() datasource.DataSource {
	return &FabricL3HandoffIPTransitsDataSource{}
}
...
func (d *FabricL3HandoffIPTransitsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_fabric_l3_handoff_ip_transits"
}

func (d *FabricL3HandoffIPTransitsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Fabric L3 Handoff IP Transits.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"l3_handoffs": schema.SetNestedAttribute{
				MarkdownDescription: "List of layer 3 handoff ip transits",
				Computed:            true,
...
func (d *FabricL3HandoffIPTransitsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {

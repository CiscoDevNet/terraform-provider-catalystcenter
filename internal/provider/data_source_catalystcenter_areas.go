...
var (
	_ datasource.DataSource              = &AreasDataSource{}
	_ datasource.DataSourceWithConfigure = &AreasDataSource{}
)
...
func (d *AreasDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Areas.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"parent_name_hierarchy": schema.StringAttribute{
							MarkdownDescription: "Parent hierarchical name (e.g., Global/USA)",
							Computed:            true,
						},
...
func (d *AreasDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {

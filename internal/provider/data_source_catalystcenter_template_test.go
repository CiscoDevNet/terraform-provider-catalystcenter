...
func TestAccDataSourceCcTemplate(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "device_types.0.product_type", "Cisco Catalyst 9300 Switch"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "language", "JINJA"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "software_type", "IOS-XE"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "software_variant", "XE"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "software_version", "16.12.1a"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_content", "hostname {{hostname}}"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.data_type", "STRING"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.default_value", "ABC"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.description", "My parameter"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.display_name", "Custom hostname"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.instruction_text", "My instructions"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.not_param", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.catalystcenter_template.test", "template_params.0.param_array", "false"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcTemplatePrerequisitesConfig + testAccDataSourceCcTemplateConfig(),
...
const testAccDataSourceCcTemplatePrerequisitesConfig = `
...
func testAccDataSourceCcTemplateConfig() string {
	...
	config += `
		data "catalystcenter_template" "test" {
			id = catalystcenter_template.test.id

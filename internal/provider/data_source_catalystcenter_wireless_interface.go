...
func NewWirelessInterfaceDataSource() datasource.DataSource {
	return &WirelessInterfaceDataSource{}
}
...
func (d *WirelessInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Wireless Interface.",
...
func (d *WirelessInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *WirelessInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	params := ""
	params += "?interfaceName=" + url.QueryEscape(config.InterfaceName.ValueString())

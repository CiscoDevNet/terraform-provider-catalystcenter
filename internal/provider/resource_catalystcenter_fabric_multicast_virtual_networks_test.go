...
func TestAccCcFabricMulticastVirtualNetworks(t *testing.T) {
	var checks []resource.TestCheckFunc

	var steps []resource.TestStep
	steps = append(steps, resource.TestStep{
		Config: testAccCcFabricMulticastVirtualNetworksPrerequisitesConfig + testAccCcFabricMulticastVirtualNetworksConfig_all(),
...
const testAccCcFabricMulticastVirtualNetworksPrerequisitesConfig = `
...
func testAccCcFabricMulticastVirtualNetworksConfig_minimum() string {
...
func testAccCcFabricMulticastVirtualNetworksConfig_all() string {
	config := `resource "catalystcenter_fabric_multicast_virtual_networks" "test" {` + "\n"
	config += `	fabric_id = catalystcenter_fabric_site.test.id` + "\n"
	config += `	virtual_networks = [{` + "\n"
	config += `	  fabric_id = catalystcenter_fabric_site.test.id` + "\n"

...
func TestAccDataSourceCcCredentialsSNMPv2Read(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCcCredentialsSNMPv2ReadConfig(),
...
func testAccDataSourceCcCredentialsSNMPv2ReadConfig() string {
	...
	config += `
		data "catalystcenter_credentials_snmpv2_read" "test" {
			id = catalystcenter_credentials_snmpv2_read.test.id
		}
	`
	return config
}

	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"fra_interval": schema.Int64Attribute{
				MarkdownDescription: "Flexible Radio Assignment interval in hours (for example, `3` for 3 hours).",
				Computed:            true,
			},
			"fra_sensitivity": schema.StringAttribute{
				MarkdownDescription: "Flexible Radio Assignment sensitivity. Values `HIGHER`, `EVEN_HIGHER`, and `SUPER_HIGH` are supported only on IOS-XE Wireless Controllers running 17.5 and above and only for the `2_4GHZ_5GHZ` radio band.",
				Computed:            true,
			},

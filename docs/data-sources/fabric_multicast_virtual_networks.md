...
page_title: "catalystcenter_fabric_multicast_virtual_networks Data Source - terraform-provider-catalystcenter"
subcategory: "SDA"
description: |-
  This data source can read the Fabric Multicast Virtual Networks.
---

# catalystcenter_fabric_multicast_virtual_networks (Data Source)
...
- `virtual_networks` (Attributes Set) List of multicast virtual networks (see [below for nested schema](#nestedatt--virtual_networks))

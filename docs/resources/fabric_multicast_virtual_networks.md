...
page_title: "catalystcenter_fabric_multicast_virtual_networks Resource - terraform-provider-catalystcenter"
subcategory: "SDA"
description: |-
  Manages Fabric Site VN Multicast
---

# catalystcenter_fabric_multicast_virtual_networks (Resource)
...
```shell
terraform import catalystcenter_fabric_multicast_virtual_networks.example "<fabric_id>"
```
